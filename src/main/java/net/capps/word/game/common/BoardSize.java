...
public enum BoardSize {
    ...
    GRANDE(9, 13, 8, 4, 4, "net/capps/word/layouts/DefaultGrandeSquareConfig.txt", 100.d, 10, 3),
    VENTI(13, 16, 14, 7, 6, "net/capps/word/layouts/DefaultVentiSquareConfig.txt", 200.d, 20, 5);
